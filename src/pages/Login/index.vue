<template>
  <Background>
    <div class="flex flex-col items-center justify-center w-full max-w-sm mx-auto px-2 sm:px-0 py-8 gap-6 relative z-10 bg-white border border-red-500 rounded-xl">
